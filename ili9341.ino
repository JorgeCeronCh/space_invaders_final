...
long previousMillis19 = 0;
long previousMillis20 = 0;
//***************************************************************************************************************************************
...
#define REST 20000
int theme[] = {
  G4,8, F4,8, REST,8, AS4,8, G4,8, AS4,8, G4,8, REST,8, 
  G4,8, F4,8, REST,8, G4,8, A4,8, AS4,-8, REST,16, A4,8, G4,-8, G4,-8, F4,4, REST,8,
  G4,8, F4,4, A4,8, AS4,8, C5,16, D5,-8, REST,-8,
  CS5,8, C5,8, AS4,-8, AS4,8, F4,4, CS5,8, C5,4, REST,16, F4,-8, FS4,-8, G4,8, REST,4,
};
...
int notes = sizeof(theme) / sizeof(theme[0]) / 2;
...
void setup() {
  ...
  for (int thisNote = 0; thisNote < notes * 2; thisNote = thisNote + 2) {
    ...
    tone(buzzer, theme[thisNote], noteDuration * 0.9);
    delay(noteDuration);
    noTone(buzzer);
  }
  /*
...
void loop() {
  ...
  if (startScreen == 1){
    if(digitalRead(start_PB) == LOW){
      ...
      tone(buzzer, G4, (wholenote/8)*0.9);
      delay(wholenote/8);
      noTone(buzzer);
      LCD_Clear(0x0000);
      startScreen = 0;
  ...
  if (mainMenu == 1){
    ...
    if (digitalRead(J1_Move) == LOW & select1 == 0){ //bajar de opcion
      ...
      tone(buzzer, F4, (wholenote/8)*0.9);
      delay(wholenote/8);
      noTone(buzzer);
      if (menu == 4){
        menu = 0;
    ...
    if (menu == 2){
      if (select1 == 0){
        ...
        if (digitalRead(start_PB) == LOW){
          ...
          LCD_Bitmap(30+SHIP_W, 70, SHIP_W, SHIP_H, nave_naranja2);
          LCD_Bitmap(30+SHIP_W+(1*SHIP_W+10), 70, SHIP_W, SHIP_H, nave_azul2);
          LCD_Bitmap(30+SHIP_W+(2*SHIP_W+20), 70, SHIP_W, SHIP_H, nave_amarilla2);
          LCD_Bitmap(30+SHIP_W+(3*SHIP_W+30), 70, SHIP_W, SHIP_H, nave_aqua2);
          LCD_Bitmap(30+SHIP_W+(4*SHIP_W+40), 70, SHIP_W, SHIP_H, nave_morada2);
          LCD_Bitmap(30+SHIP_W+(5*SHIP_W+50), 70, SHIP_W, SHIP_H, nave_verde2);  
          LCD_Print("P2", SCREEN_WIDTH-50-SHIP_W-(5*SHIP_W+50)-52, SCREEN_HEIGHT-65, 2, 0xFFFF, 0x4229);
          LCD_Bitmap(SCREEN_WIDTH-50-SHIP_W, SCREEN_HEIGHT-70, SHIP_W, SHIP_H, nave_naranja2);
          LCD_Bitmap(SCREEN_WIDTH-50-SHIP_W-(1*SHIP_W+10), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, nave_azul2);
          LCD_Bitmap(SCREEN_WIDTH-50-SHIP_W-(2*SHIP_W+20), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, nave_amarilla2);
          LCD_Bitmap(SCREEN_WIDTH-50-SHIP_W-(3*SHIP_W+30), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, nave_aqua2);
          LCD_Bitmap(SCREEN_WIDTH-50-SHIP_W-(4*SHIP_W+40), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, nave_morada2);
          LCD_Bitmap(SCREEN_WIDTH-50-SHIP_W-(5*SHIP_W+50), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, nave_verde2); 
        }
      }
      if (select1 == 1){
        playerShipSelect();
  ...
  if(num_aliens_destroyed == 20){
    ...
    if (level > 2 & player1_final_score > player2_final_score){
      ...
      for (int thisNote = 0; thisNote < notes2 * 2; thisNote = thisNote + 2) {
        ...
        tone(buzzer, victory[thisNote], noteDuration2 * 0.9);
        delay(noteDuration2);
        noTone(buzzer);
        if(cont >= 8){
          LCD_Clear(0x0000);
...
void playerShipSelect(void){
  ...
  switch (ship_select1){
    ...
    case 1:
      ...
      Rect(30+SHIP_W+(1*SHIP_W+10), 70, SHIP_W, SHIP_H, 0xFFFF);
      break;
    case 2:
  ...
  switch (ship_select2){
    case 0:
      Rect(SCREEN_WIDTH-50-SHIP_W-(5*SHIP_W+50), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, 0x4229);
      Rect(SCREEN_WIDTH-50-SHIP_W, SCREEN_HEIGHT-70, SHIP_W, SHIP_H, 0xFFFF);
      break;
    case 1:
      Rect(SCREEN_WIDTH-50-SHIP_W, SCREEN_HEIGHT-70, SHIP_W, SHIP_H, 0x4229);
      Rect(SCREEN_WIDTH-50-SHIP_W-(1*SHIP_W+10), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, 0xFFFF);
      break;
    case 2:
      Rect(SCREEN_WIDTH-50-SHIP_W-(1*SHIP_W+10), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, 0x4229);
      Rect(SCREEN_WIDTH-50-SHIP_W-(2*SHIP_W+20), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, 0xFFFF);
      break;
    case 3:
      Rect(SCREEN_WIDTH-50-SHIP_W-(2*SHIP_W+20), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, 0x4229);
      Rect(SCREEN_WIDTH-50-SHIP_W-(3*SHIP_W+30), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, 0xFFFF);
      break;
    case 4:
      Rect(SCREEN_WIDTH-50-SHIP_W-(3*SHIP_W+30), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, 0x4229);
      Rect(SCREEN_WIDTH-50-SHIP_W-(4*SHIP_W+40), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, 0xFFFF);
      break;
    case 5:
      Rect(SCREEN_WIDTH-50-SHIP_W-(4*SHIP_W+40), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, 0x4229);
      Rect(SCREEN_WIDTH-50-SHIP_W-(5*SHIP_W+50), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, 0xFFFF);
      break;
  }
}
...
void nextLevel(void){
  switch(level){
    case 1:
      ...
      FillRect(0, 223, 320, 240-223, 0x0841);
      LCD_Print("ROUND 2", 105, 220, 2, 0xFFFF, 0x0841);
      delay(300);
      LCD_Print("ROUND 2", 105, 220, 2, 0xF800, 0x0841);
      delay(300);
      LCD_Print("ROUND 2", 105, 220, 2, 0xFFFF, 0x0841);
      delay(300);
      LCD_Print("ROUND 2", 105, 220, 2, 0xF800, 0x0841);
    ...
    case 2:
      LCD_BitmapSD(0, 0, 320, 240, "cambio.txt");
      FillRect(0, 223, 320, 240-223, 0x0841);
      LCD_Print("FINAL ROUND", 68, 220, 2, 0xFFFF, 0x0841);
      delay(100);
      LCD_Print("FINAL ROUND", 68, 220, 2, 0xF800, 0x0841);
      delay(100);
      LCD_Print("FINAL ROUND", 68, 220, 2, 0xFFFF, 0x0841);
      delay(100);
      LCD_Print("FINAL ROUND", 68, 220, 2, 0xF800, 0x0841);
...
void fireMissiles(void){
  if(dataIn1 == 0x33 & dataIn2 == 0){
    if(missile_status == DESTROYED){
      ...
      if (currentMillis15 - previousMillis15 > (wholenote/8)){
        tone(buzzer, GS4, (wholenote/8)*0.9);
  ...
  if(dataIn2 == 0x36 & dataIn1 == 0){
    if(missile_status2 == DESTROYED2){
      ...
      if (currentMillis16 - previousMillis16 > (wholenote/8)){
        tone(buzzer, GS4, (wholenote/8)*0.9);
        previousMillis16 = currentMillis16;
      }      
      else{
        noTone(buzzer);
      }
  ...
  if(dataIn1 == 0x33 & dataIn2 == 0x36){
    if(missile_status == DESTROYED & missile_status2 == DESTROYED2){
      ...
      if (currentMillis17 - previousMillis17 > (wholenote/8)){
        tone(buzzer, GS4, (wholenote/8)*0.9);
        previousMillis17 = currentMillis17;
      }      
      else{
        noTone(buzzer);
      }
    ...
    if(missile_status == ACTIVE & missile_status2 == DESTROYED2){
      unsigned long currentMillis18 = millis();
      if (currentMillis18 - previousMillis18 > (wholenote/8)){
        tone(buzzer, GS4, (wholenote/8)*0.9);
        previousMillis18 = currentMillis18;
      }      
      else{
        noTone(buzzer);
      }
    ...
    if(missile_status == DESTROYED & missile_status2 == ACTIVE2){
      unsigned long currentMillis19 = millis();
      if (currentMillis19 - previousMillis19 > (wholenote/8)){
        tone(buzzer, GS4, (wholenote/8)*0.9);
        previousMillis19 = currentMillis19;
      }      
      else{
        noTone(buzzer);
      }
